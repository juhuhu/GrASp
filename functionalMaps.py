...
def parse_args():
    ...
    parser.add_argument('--n_eig', type=int, default=1132, help="how many eigenvectors to compute")
    parser.add_argument('--lower_t', type=float,default=1.0, help='smallest timestep for corresponding functions')
    parser.add_argument('--upper_t', type=float,default=50.0, help='biggest timestep for corresponding functions')
    parser.add_argument('--linsteps', type=bool, default=True, help='scaling of time steps of corresponding functions, logarithmically or linearly')
...
def main(args):
    ...
    if(args.base_align):
        matching=functional_maps_base_align(A1,A2,args.q, args.k,args.n_eig,args.laa,args.icp, args.icp_its, args.lower_t, args.upper_t, args.linsteps,args.graph,0,0)
    else:
        matching=functional_maps(A1,A2,args.q, args.k,args.n_eig,args.laa,args.icp, args.icp_its, args.lower_t, args.upper_t, args.linsteps,args.graph)
...
def functional_maps_base_align(A1, A2,q,k,n_eig,laa,icp, icp_its, lower_t, upper_t, linsteps,graph_name,i,j):
